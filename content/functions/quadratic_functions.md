...
<script src="../../_static/jsxgraphcore.js"></script>
<script src="../../_static/math.min.js"></script>
<script src="../../_static/math_visualiser.js"></script>
<script src="../../_static/MCQModule.js"></script>
<script src="../../_static/IdentityQuestions.js"></script>
<link rel="stylesheet" href="../../_static/jsxgraph.css">
<link rel="stylesheet" href="../../_static/MCQCSS.css">
<link rel="stylesheet" href="../../_static/math_visualiser.css">
...
<div id="quadratic-form-container" class="visualization-container"></div>
        ...
        "questions": [
            ...
            },
            {
                ...
                "answer": `
                    ...
                    <p>(1.5,0): At the edges (\\(x = ±1.5\\)), the height is 0 (the base)</p>
...
<div id="factorization-container" class="visualization-container" style="width: 100%; height: 500px;"></div>
...
<div id="completing-square-container" class="visualization-container" style="width: 100%; height: 500px;"></div>
...
<div id="quadratic-formula-container" class="visualization-container" style="width: 100%; height: 500px;"></div>
...
<div id="discriminant-container" class="visualization-container" style="width: 100%; height: 500px;"></div>
        ...
        "questions": [
            ...
            },
            {
                ...
                "answer": `
                    ...
                    <p>\(x = \frac{2640}{2 \times 3} = \frac{2640}{6} = 440\) Hz</p>
                    
                    <p>This means the frequency that satisfies the equation is 440 Hz, which is identical to our reference note. This represents a unison (1:1 ratio), the most basic harmony where both notes have the same frequency.</p>
                    
                    <p>To verify, we can check this solution in the original equation:</p>
                    <p>\(3(440)^2 - 2640(440) + 580800\)</p>
                    <p>\(3(193600) - 2640(440) + 580800\)</p>
                    <p>\(580800 - 1161600 + 580800 = 0\) ✓</p>
                    
                    <p>The fact that the solution is the reference note itself suggests this equation was constructed to have this property, perhaps to demonstrate a baseline or reference point in a study of musical harmonics.</p>
                    ...
                    <p>\(6969600 - 6969600 - 12k < 0\)</p>
                    <p>\(-12k < 0\)</p>
                    <p>\(k > 0\)</p>
                    
                    <p>Therefore, any positive value of \(k\) would result in no real solutions to the equation.</p>
                    
                    <p>Musically, this would mean that no frequencies exist that can form the specific harmonic relationship described by the modified equation. This could represent a situation where a "perfect" harmony becomes impossible when the harmonic system is perturbed or shifted.</p>
                    
                    <p>In practical terms, if \(k\) represents some detuning or alteration of the harmonic structure, then a positive \(k\) would create a scenario where the desired harmonic relationship cannot be achieved with real frequencies. This might represent a dissonant or unstable harmonic relationship that musicians might use for tension or special effects.</p>
                    
                    <p>For example, in some contemporary music and microtonality, composers deliberately work with frequency relationships that don't align with traditional Western harmony, creating unique timbres and emotional medolies.</p>`
                }
            ]
    };
